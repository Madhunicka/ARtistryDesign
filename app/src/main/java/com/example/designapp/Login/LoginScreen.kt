        ...
        OutlinedTextField(
            ...
            trailingIcon = {
                IconButton(
                    ...
                    PasswordVisibilityToggleIcon(isPasswordVisible)
                }
            },
...
@Composable
fun PasswordVisibilityToggleIcon(isPasswordVisible: Boolean) {
...
//    val sharedPreferences: SharedPreferences = context.getSharedPreferences("login_preferences", Context.MODE_PRIVATE)
//
//    // Retrieve saved email and password when the screen is first created or when rememberPassword changes
...
//            keyboardActions = KeyboardActions(
//                onDone = {
//                    saveCredentials(context, email, password, rememberPassword)
//                    // Handle login
//                }
//            ),
//            modifier = Modifier.fillMaxWidth(),
...
//                    // Save the rememberPassword state when it changes
//                    sharedPreferences.edit().putBoolean("rememberPassword", newValue).apply()
//                },
//                modifier = Modifier.padding(end = 8.dp)
//            )
...
//}
//
//fun saveCredentials(context: Context, email: String, password: String, rememberPassword: Boolean) {
